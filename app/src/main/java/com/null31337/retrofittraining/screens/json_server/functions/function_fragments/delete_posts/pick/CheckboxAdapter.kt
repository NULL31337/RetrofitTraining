package com.null31337.retrofittraining.screens.json_server.functions.function_fragments.delete_posts.pick
...
class CheckboxAdapter : RecyclerView.Adapter<CheckboxAdapter.CheckboxViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CheckboxViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.layout_post_with_checkbox, parent, false)
